...
import { MESSAGE_TYPES, THEMES, STORAGE_KEYS, MAX_ATTEMPTS, API_BASE_URL } from './constants.js';
...
export class UI {
  ...
  bindElements() {
    ...
    this.profileModalOverlay = document.getElementById('profile-modal-overlay');
  ...
  async fetchUserProfile() {
    try {
      ...
      if (response.ok) {
        ...
        this.profileModalOverlay.style.display = 'flex';
      } else {
  ...
  closeProfileModal() {
    this.profileModalOverlay.style.display = 'none';
  }

  displayUserProfile(data) {
    document.getElementById('profile-username').innerText = data.username;
    document.getElementById('profile-high-score').innerText = data.highScore;
    document.getElementById('profile-streak').innerText = data.streak;
    document.getElementById('profile-registration-date').innerText = new Date(data.registrationDate).toLocaleDateString();
  }
}
